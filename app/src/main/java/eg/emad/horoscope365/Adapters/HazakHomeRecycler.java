...
import eg.emad.horoscope365.Hazak;
...
public class HazakHomeRecycler extends RecyclerView.Adapter<HazakHomeRecycler.MyViewHolder>{
    ArrayList<HomeItem> homeItems = new ArrayList<>();
    Context context;

    public HazakHomeRecycler(ArrayList<HomeItem> homeItems, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new HazakHomeRecycler.MyViewHolder(view);
    }
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    intent = new Intent(context, Hazak.class);
